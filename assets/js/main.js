$(function () {
    ...
    $(".send-pm").click(function (e) {
        ...
        var content = "" +
            ...
            "<div class=\"panel-footer\"><small>The AOD forums enforce a 20-member limit on PM messages. To respect this limitation, the following buttons will generate a separate PM to each set of 20 members.</small></div></div>";
    ...
    function memberPm(members) {
        ...
        for (w = 0; w < x; w++) {
            ...
            var pmUrl = "http://www.clanaod.net/forums/private.php?do=newpm&u[]="
                    + implode('&u[]=', names) + "/",
                link = "<a class=\"btn btn-default\" target='_blank' href=\"" + pmUrl + "\">PM Link #" + (w + 1) + "</a>";
