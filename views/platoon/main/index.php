		...
		<div class="col-xs-5">
			<?php if ($user->role >= 2 || User::isDev()) : ?>
				...
				<div class="btn-group pull-right">
					...
					<?php endif; ?>
					<a class="btn btn-default send-pm" data-members="<?php echo ($memberIdList) ? implode(",", $memberIdList) : NULL; ?>" href="<?php echo PRIVMSG; ?>" target="_blank"><i class="fa fa-comment"></i> Send Platoon PM</a>
				</div>
