...
<body>
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="member/<?php echo $member->member_id; ?>"><?php echo ucwords($member->forum_name); ?>
                                            <span
                                                class="pull-right"><?php echo Member::avatar($member->member_id) ?></span></a>
                                    </li>
                                    <li class="divider"></li>
    ...
    <div id="footer" class="navbar navbar-default">
        <div class="container">
            <small class="text-muted">Copyright &copy; Angels of Death <span class="hidden-xs">2014-2016. All rights reserved.</span><br/><span
