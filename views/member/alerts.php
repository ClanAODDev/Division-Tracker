<?php if ($memberInfo->status_id == 4) : ?><!-- member is removed -->
	<div class='alert alert-danger'><i class='fa fa-times-circle fa-lg'></i> This member is currently not active in any division supported by the tracker. To add this member to a division, they will need to go through the recruiting process.</div>
