                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                                 aria-valuemax="100" style="width: {{profile.battle_rank.percent_to_next}}%;">
                    ...
                    <div class="col-sm-8">
                        <div ng-show="chart==1">
                            ...
                            <canvas id="{{profile.name.first}}-month-bar" class="chart chart-line"
                                    chart-data="profile.playtime.month.chart.data"
                                    chart-labels="profile.playtime.month.chart.labels" chart-options="chartoptions"
                        ...
                        <div ng-show="chart==2">
                            ...
                            <canvas id="{{profile.name.first}}-day-bar" class="chart chart-line"
                                    chart-data="profile.playtime.day.chart.data"
                                    chart-labels="profile.playtime.day.chart.labels" chart-options="chartoptions"
                                    height="300" width="600">
                            </canvas>
                        </div>
                        <hr />
                        <ul class="nav nav-pills" ng-init="chart=1">
                            <li role="presentation" ng-class="{active:chart==1}" ng-click="chart=1"><a
                                        href="#">month</a></li>
                            <li role="presentation" ng-class="{active:chart==2}" ng-click="chart=2"><a href="#">day</a>
                            </li>
                        </ul>
                    </div>
                    <hr />

                    <strong>Effective Platoon leading</strong><br />
                    <small>score is calculated by the sum of platoon leading ribons earned (platoon leading=1, platoon conquest=2)</small>

                    <canvas id="{{profile.name.first}}-pl-day-bar" class="chart chart-line"
                            chart-data="profile.platoonleading.data" chart-labels="profile.platoonleading.labels"
                            chart-options="chartoptions" height="300" width="900">
                    </canvas>
                    <strong> Average:</strong> {{profile.platoonleading.avg}}

                    <hr />
                    <strong>Squad leading</strong><br />
                    <small>score is calculated by the sum of squad leading ribons earned (Squad Leading=1, Drill Sergeant =1, Squad Spawn =1)</small>
                    <canvas id="{{profile.name.first}}-sl-day-bar" class="chart chart-line"
                            chart-data="profile.squadleading.data" chart-labels="profile.squadleading.labels"
                            chart-options="chartoptions" height="300" width="900">
                    </canvas>
