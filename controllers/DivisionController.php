...
class DivisionController
{
    ...
    public static function _index($div)
    {
        ...
        if (property_exists($division, 'id')) {
            $division_leaders = Division::findDivisionLeaders($division->id, true);
    ...
    public static function _manage_inactives()
    {
        ...
        Flight::render('manage/inactive_members', [
            'member' => $member,
            'user' => $user,
    ...
    public static function _manage_part_time()
    {
        ...
        Flight::render('manage/part_time', ['member' => $member, 'user' => $user, 'part_time' => $part_time],
            'content');
        Flight::render('layouts/application', [
            'user' => $user,
            'member' => $member,
    ...
    public static function _doRemovePartTimeMember($id)
    {
        ...
        if ($user->role > 0) {
            ...
            if (PartTime::delete($id)) {
                ...
                $data = ['success' => false, 'message' => "Member does not exist!"];
            }
        } else {
            $data = ['success' => false, 'message' => "You do not have access to perform this function"];
        }
    ...
    public static function _manage_loas()
    {
        ...
        Flight::render('manage/loas', ['division' => $division, 'member' => $member, 'user' => $user], 'content');
        Flight::render('layouts/application', [
            'user' => $user,
            'member' => $member,
            'tools' => $tools,
    ...
    public static function _generateDivisionStructure()
    {
        ...
        switch ($member->game_id) {
            ...
            case 4:
                ...
                break;
            case 5:
                $division_structure = new TCDivisionStructure($member->game_id);
                break;
            case 6:
        ...
        Flight::render('modals/division_structure', ['division_structure' => $division_structure->content]);
    }
    ...
    public static function _updateLoa()
    {
        ...
        if (isset($_POST['remove']) || isset($_POST['approve'])) {
            ...
            if ($user->role < 2) {
                $data = ['success' => false, 'message' => "You are not authorized to perform that action."];
            } else {
                ...
                if (isset($_POST['remove'])) {
                    ...
                    $data = ['success' => true, 'message' => "Leave of absence successfully removed."];
                    ...
                    if (isset($_POST['approve'])) {
                        ...
                        if ($member->member_id == $loa->member_id) {
                            ...
                            $data = ['success' => true, 'message' => "Leave of absence successfully approved."];
                        }
            ...
            if ($name) {
                if (strtotime($date) > strtotime('now')) {
                    if (LeaveOfAbsence::exists($member->member_id)) {
                        $data = ['success' => false, 'message' => "This member already has an LOA in place!"];
                    } else {
                    ...
                    $data = ['success' => false, 'message' => "Date cannot be before today's date."];
                }
            } else {
                $data = ['success' => false, 'message' => 'The member id you provided appears to be invalid.'];
            }
