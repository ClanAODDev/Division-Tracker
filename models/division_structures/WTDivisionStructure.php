...
class WTDivisionStructure
{
    ...
    public function generate()
    {
        ...
        $division_structure .= "LOA: " . LeaveOfAbsence::count_active($this->game_id) . "\r\n";
        ...
        foreach ($general_sergeants as $player) {
            ...
            $player->handle = (is_object($memberHandle))
                ? "[url=http://warthunder.com/en/community/userinfo/?nick={$memberHandle->handle_value}][color=00ff00]⟹[/color][/url]"
                : 'XXX';
